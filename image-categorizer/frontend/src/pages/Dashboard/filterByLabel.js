...
class FilterByLabel extends React.Component{
  constructor(props){
    super(props);
    this.state = {
      genres: [],
  ...
  render() {
    ...
    const { currentPage, pageSize,currentOption} = this.state;
...
const mapDispatchToProps = (dispatch) => {
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(FilterByLabel);
